...
mod tests {
    ...
    fn test_registry_with_extensions() {
        ...
        assert!(
            registry.get("terminal.execute").is_some(),
            "terminal.execute should be registered"
        );
        assert!(
            registry.get("terminal.read").is_some(),
            "terminal.read should be registered"
        );
        assert!(
            registry.get("terminal.write").is_some(),
            "terminal.write should be registered"
        );
    }
